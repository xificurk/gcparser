...
#                Hint text
# </div>
__pcresMask["cacheHint"] = ("<div id=['\"]div_hint['\"][^>]*>\s*\n\s*(.*?)\s*\n\s*</div>", re.I)
...
# <img src="/images/WptTypes/2.gif" alt="Traditional Cache" width="32" height="32" /></a>
__pcresMask["listType"] = ("<img src=['\"]/images/WptTypes/[^'\"]+['\"] alt=\"([^\"]+)\"[^>]*></a>", re.I)
